...
<footer id="footer" class="site-footer">
	<div class="footer-inner">
		...
		<div class="footer-col footer-contact">
			<h2 class="footer-heading"><?php esc_html_e( 'Kontakt', 'containertheme' ); ?></h2>
		...
		<div class="footer-col footer-links">
			<h2 class="footer-heading"><?php esc_html_e( 'Rechtliches', 'containertheme' ); ?></h2>
			<?php
			wp_nav_menu(
				array(
		...
		<div class="footer-col footer-social">
			<h2 class="footer-heading"><?php esc_html_e( 'Folgen Sie uns', 'containertheme' ); ?></h2>
