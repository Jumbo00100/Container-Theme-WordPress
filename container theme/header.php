...
<header id="header" class="site-header">
	...
	<div class="header-inner">
		...
		<button class="nav-toggle" aria-expanded="false" aria-controls="site-nav">
			...
			<span class="screen-reader-text"><?php esc_html_e( 'Menü', 'containertheme' ); ?></span>
		</button>

		<nav id="site-nav" class="site-nav" aria-label="<?php esc_attr_e( 'Hauptnavigation', 'containertheme' ); ?>">
			<?php
			wp_nav_menu(
				array(
		...
		<div class="header-actions">
			<?php if ( class_exists( 'WooCommerce' ) && function_exists( 'wc_get_cart_url' ) ) : ?>
				...
				<a class="header-cart" href="<?php echo esc_url( wc_get_cart_url() ); ?>">
					...
					<span class="screen-reader-text"><?php echo esc_html( sprintf( /* translators: %d: items in cart */ __( 'Warenkorb, %d Artikel', 'containertheme' ), $ccn_cart_count ) ); ?></span>
				</a>
			<?php endif; ?>
			...
			<div class="header-search">
				<button class="search-toggle" aria-expanded="false" aria-controls="header-search-form">
					...
					<span class="screen-reader-text"><?php esc_html_e( 'Suche', 'containertheme' ); ?></span>
				</button>
				<form id="header-search-form" class="header-search-form" role="search" method="get" action="<?php echo esc_url( home_url( '/' ) ); ?>" hidden>
					<label class="screen-reader-text" for="header-search-input"><?php esc_html_e( 'Suche', 'containertheme' ); ?></label>
					<input id="header-search-input" type="search" name="s" placeholder="<?php esc_attr_e( 'Suchen …', 'containertheme' ); ?>" value="<?php echo esc_attr( get_search_query() ); ?>">
					<button type="submit" class="btn btn-primary"><?php esc_html_e( 'Suchen', 'containertheme' ); ?></button>
				</form>
			</div>
		</div>
	</div>
