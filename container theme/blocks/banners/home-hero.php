 ...
 * big left-aligned heading — mirrors the original containertheme.
...
if ( $ccn_preview && ! $ccn_title && ! $ccn_img_id ) : ?>
	<p><em><?php esc_html_e( 'Home hero: pick a background image and a title in the block sidebar.', 'containertheme' ); ?></em></p>
	<?php
	return;
endif;
?>
