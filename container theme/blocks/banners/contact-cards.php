...
if ( ! $ccn_email && ! $ccn_phone && ! $ccn_address ) {
	if ( ! empty( $is_preview ) ) {
		echo '<p><em>' . esc_html__( 'Contact cards: fill email, phone and address in Site Settings.', 'containertheme' ) . '</em></p>';
	}
	return;
}
?>
	...
	<div class="ccn-contact-cards-inner">
		<?php if ( $ccn_email ) : ?>
			<div class="ccn-contact-card">
				...
				<span class="ccn-contact-card-label"><?php esc_html_e( 'E-Mail', 'containertheme' ); ?></span>
		...
		<?php if ( $ccn_phone ) : ?>
			<div class="ccn-contact-card is-dark">
				...
				<span class="ccn-contact-card-label"><?php esc_html_e( 'Telefon', 'containertheme' ); ?></span>
		...
		<?php if ( $ccn_address ) : ?>
			<div class="ccn-contact-card">
				...
				<span class="ccn-contact-card-label"><?php esc_html_e( 'Adresse', 'containertheme' ); ?></span>
