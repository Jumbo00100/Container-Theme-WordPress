...
<aside class="ccn-landing-sidebar">
	<?php if ( $ccn_links ) : ?>
		<nav class="ccn-sidebar-services" aria-label="<?php esc_attr_e( 'Unsere Dienstleistungen', 'containertheme' ); ?>">
			<h2 class="ccn-sidebar-heading"><?php esc_html_e( 'Unsere Dienstleistungen', 'containertheme' ); ?></h2>
